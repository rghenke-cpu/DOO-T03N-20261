...
public class TelaAssistidas extends JFrame {
    ...
    public TelaAssistidas(Usuario usuario) {
    ...
    private void atualizarLista() {
        ...
        for (Serie s : usuario.getseriesAssistidas()) {
    ...
    private void removerSerie() {
        ...
        int op = JOptionPane.showConfirmDialog(
                this,
                "Remover esta série da lista de assistidas?",
                "Confirmação",
                JOptionPane.YES_NO_OPTION);

        if (op == JOptionPane.YES_OPTION) {

            usuario.removerSeriesAssistida(serie);
    ...
    private void ordenar() {
        ...
        switch (escolha) {
            ...
            case "Nome":
                OrdenadorSerie.ordenarPorNome(usuario.getseriesAssistidas());
                break;

            case "Nota":
                OrdenadorSerie.ordenarPorNota(usuario.getseriesAssistidas());
                break;

            case "Status":
                OrdenadorSerie.ordenarPorStatus(usuario.getseriesAssistidas());
                break;

            case "Data de Estreia":
                OrdenadorSerie.ordenarPorDataDeEstreia(usuario.getseriesAssistidas());
                break;
