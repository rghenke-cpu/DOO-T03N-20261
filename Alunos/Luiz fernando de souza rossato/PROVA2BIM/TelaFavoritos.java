...
public class TelaFavoritos extends JFrame {
    ...
    private void atualizarLista(){
        ...
        for(Serie s : usuario.getseriesFavoritas()){
    ...
    private void removerSerie(){
        ...
        int op = JOptionPane.showConfirmDialog(
                this,
                "Remover esta série dos favoritos?",
                "Confirmação",
                JOptionPane.YES_NO_OPTION);

        if(op == JOptionPane.YES_OPTION){

            usuario.removerSeriesFavoritas(serie);
    ...
    private void ordenar(){
        ...
        switch(escolha){
            ...
            case "Nome":
                OrdenadorSerie.ordenarPorNome(usuario.getseriesFavoritas());
                break;

            case "Nota":
                OrdenadorSerie.ordenarPorNota(usuario.getseriesFavoritas());
                break;

            case "Status":
                OrdenadorSerie.ordenarPorStatus(usuario.getseriesFavoritas());
                break;

            case "Data de Estreia":
                OrdenadorSerie.ordenarPorDataDeEstreia(usuario.getseriesFavoritas());
                break;
